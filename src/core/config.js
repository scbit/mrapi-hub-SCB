...
module.exports = Object.freeze({
  ...
  deskDb: String(process.env.MRAPI_DESK_DB || "scb-desk").trim(),
  deskBaseUrl: String(process.env.MRAPI_DESK_BASE_URL || process.env.DESK_BASE_URL || "https://scb-desk-604957912671.us-central1.run.app").replace(/\/$/, ""),
